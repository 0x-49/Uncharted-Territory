  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <h1 className="reveal animate-slide-up animate-delay-100 font-display text-[clamp(2.5rem,8vw,6rem)] text-white leading-[1] tracking-tight mb-6 md:mb-8">
        ...
        <p className="reveal animate-slide-up animate-delay-200 text-base md:text-lg text-white/50 max-w-xl mx-auto mb-10 leading-relaxed px-4">
          Join 3,300+ traders getting daily trade alerts, live Zoom sessions, and workshops that teach you to think about the markets. Start your journey to consistent profits today.
        </p>
        ...
        <div className="reveal animate-slide-up animate-delay-400 flex flex-wrap items-center justify-center gap-5 md:gap-6 text-xs text-white/40">
          ...
          <span><span className="text-white/70 font-medium">3,300+</span> members</span>
          <span className="w-px h-3 bg-white/10" />
